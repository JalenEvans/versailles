...
| 2026-08-31 | associate-head-coach | Drop the verifiedPure gate (ADR-0019): predicate declaration schema is { source, params, paramTypes, returnType }; purity metadata and the gate are removed; the declaration (existence + shape + resolvable sourceRef) is the attestation |
