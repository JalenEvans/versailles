...
|---|---|---|
| [Getting started — zero to green](getting-started.md) | New users | The full contract-first TDD loop: scaffold, author a contract, validate, generate, read the suite, Red → Green, `check` + commit; brownfield via `extract-manifests` |
